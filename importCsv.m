...
for i_file = 1 : number_of_files
            ...
            if isstruct(imported_data)
                ...
                if strcmp(data_class, 'Devices')
                    ...
                    if strcmp(data_group{2}(1 : 17), 'Delsys Trigno EMG')
                        ...
                        % save emg data
                        matlab_data_file_name = makeFileName(date, subject_id, trial_type, trial_number, 'emgTrajectoriesRaw');
                        save ...
                          ( ...
    ...
    elseif strcmp(file_type, 'unknown')
        ...
        % save
        matlab_data_file_name = makeFileName(date, subject_id, trial_type, trial_number, file_type);
...
for i_file = 1 : length(file_name_list)
    ...
    movefile(data_file_name, ['../processed/' data_file_name]);
end

disp(['moved imported files to ..' filesep 'processed'])
