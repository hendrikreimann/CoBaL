function [fit_data, fit_period, fit_offset_x, fit_offset_y, fit_amplitude] = sinusoidFit(time, data, period_init, offset_x, offset_y_init, amplitude_init)
% function sinusoidFit(time, data, period_init, offset_x_init, offset_y_init, amplitude_init)
    ...
    fit_data_init = generateSinusoid(time, period_init, offset_x, offset_y_init, amplitude_init);
    parameters_init = [offset_y_init, amplitude_init];
...
%     parameters_fit = fminunc(@sawtoothDifference, parameters_init, options);
    ...
    fit_period = 70;
    fit_offset_x = offset_x;
    fit_offset_y = parameters_fit(1);
    fit_amplitude = parameters_fit(2);
