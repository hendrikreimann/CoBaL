...
function createStanceModel(varargin)
    ...
    LELB_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'L_elbow')';
    LWRI_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'L_wrist')';

    % right arm
    RSHO_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'R_shoulder')';
    RELB_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'R_elbow')';
    RWRI_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'R_wrist')';
    ...
    LTOE_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'L_toe')';
    ...
    RTOE_reference = extractMarkerTrajectories(marker_reference, marker_labels, 'R_toe')';
