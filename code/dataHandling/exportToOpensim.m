        ...
        for i_trial = trials_to_process
            ...
            if strcmp(type, 'forceplate') || strcmp(type, 'all')
                ...
                if exist(['processed' filesep forceplate_file_name], 'file')
                    ...
                    wrench_total_world = spline(time_forceplate, total_forceplate_wrench_world', time_mocap)';
                    ...
                    cop_total_world = [spline(time_forceplate, total_forceplate_cop_world', time_mocap)', zeros(size(time_mocap))];
