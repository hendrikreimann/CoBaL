...
function [condition_cell, header] = loadConditionTableFromFile(filename)
    % read file
    ...
    condition_cell = cell(number_of_trials, number_of_conditions+1);
    
    condition_cell = strsplit(text_cell{1}, ',');
    for i_trial = 1 : number_of_trials
        ...
        condition_cell(i_trial, :) = line_split;
    end
