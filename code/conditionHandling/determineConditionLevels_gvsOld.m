...
function [conditions_trial, event_variables_to_save, removal_flags] = determineConditionLevels_gvsOld(study_settings, subject_settings, trial_data)
    ...
    for i_trigger = 1 : number_of_triggers
        ...
        % determine delay
        wait_time_stim = trial_data.time_stimulus(trial_data.stim_start_indices_stimulus(i_trigger)) - trial_data.time_stimulus(trial_data.trigger_indices_stimulus(i_trigger));
...
%     trial_data.trigger_indices_stimulus = trial_data.trigger_indices_stimulus(unflagged_indices, :);
