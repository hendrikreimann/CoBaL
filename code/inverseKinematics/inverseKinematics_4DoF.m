...
function inverseKinematics_4DoF(varargin)
    % parse arguments
    ...
    head_reference = mean([eye_L_reference eye_R_reference], 2);
    ...
    head_vector_reference = head_reference - shoulder_reference;
    ...
    for i_condition = 1 : length(condition_list)
        ...
        for i_trial = trials_to_process
            ...
            eye_R_position = extractMarkerData(marker_trajectories, marker_labels, 'REYE');
            ...
            head_mid = (eye_L_position + eye_R_position) * 0.5;
            ...
            joint_angle_trajectories = [ankle_joint_angle knee_joint_angle hip_joint_angle neck_joint_angle];
