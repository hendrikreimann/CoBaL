...
% disp('----------------------------------------------------------------------')    
    ...
    if false
        ...
        LASI_current = extractMarkerData(marker_current, marker_headers, 'LASI')';
        RASI_current = extractMarkerData(marker_current, marker_headers, 'RASI')';
        LPSI_current = extractMarkerData(marker_current, marker_headers, 'LPSI')';
        RPSI_current = extractMarkerData(marker_current, marker_headers, 'RPSI')';

        LASI_reference = extractMarkerData(marker_reference, marker_headers, 'LASI')';
        RASI_reference = extractMarkerData(marker_reference, marker_headers, 'RASI')';
        LPSI_reference = extractMarkerData(marker_reference, marker_headers, 'LPSI')';
        RPSI_reference = extractMarkerData(marker_reference, marker_headers, 'RPSI')';
