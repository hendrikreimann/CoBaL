...
%               );
            this.saveEventsButton = uicontrol ...
              ( ...
                events_panel, ...
                'Style', 'pushbutton', ...
                'Position', [5, row_1_offset, 100, button_height], ...
                'Fontsize', 12, ...
                'String', 'Save Events', ...
                'KeyPressFcn', @this.processKeyPress, ...
                'callback', @event_data.saveEvents ...
              );
            this.toggleAutoSaveEventsButton = uicontrol ...
              ( ...
                events_panel, ...
                'Style', 'pushbutton', ...
                'Position', [105, row_1_offset, 100, button_height], ...
                'Fontsize', 12, ...
                'String', '<html><center>Auto-Save<br>Events</center>', ...
                'KeyPressFcn', @this.processKeyPress, ...
                'callback', @this.toggleAutoSaveEvents ...
              );
            this.findStretchesButton = uicontrol ...
              ( ...
                events_panel, ...
                'Style', 'pushbutton', ...
                'Position', [205, row_1_offset, 100, button_height], ...
                'Fontsize', 12, ...
            ...
            this.automateStretchFindingButton = uicontrol ...
              ( ...
                events_panel, ...
                'Style', 'pushbutton', ...
                'Position', [305, row_1_offset, 100, button_height], ...
                'Fontsize', 12, ...
            ...
            this.lockAddEventsButton = uicontrol ...
              ( ...
                ...
                'Fontsize', 12, ...
                'String', '<html><center>Lock Add<br></center>Events Buttons', ...
                'KeyPressFcn', @this.processKeyPress, ...
            ...
            if this.gui_settings.get('toggle_auto_save_events', 1)
                set(this.toggleAutoSaveEventsButton, 'ForegroundColor', this.color_selected)
            else
                set(this.toggleAutoSaveEventsButton, 'ForegroundColor', this.color_normal)
            end
            if this.gui_settings.get('toggle_auto_stretch_finding', 1)
                set(this.automateStretchFindingButton, 'ForegroundColor', this.color_selected)
            else
                set(this.automateStretchFindingButton, 'ForegroundColor', this.color_normal)
            end
            if this.gui_settings.get('lock_add_events_buttons', 1)
                set(this.lockAddEventsButton, 'ForegroundColor', this.color_selected)
            else
                set(this.lockAddEventsButton, 'ForegroundColor', this.color_normal)
            end
...
%             end
        ...
        function processKeyPress(this, sender, eventdata)
            ...
            if strcmp(eventdata.Key, 'delete') || strcmp(eventdata.Key, 'backspace')
                ...
                if get(this.toggleAutoSaveEventsButton, 'ForegroundColor') == this.color_selected
                    % automatic saving requested
...
%             end
        ...
        function toggleAutoSaveEvents(this, sender, ~)
            if get(sender, 'ForegroundColor') == this.color_normal
                set(sender, 'ForegroundColor', this.color_selected);
