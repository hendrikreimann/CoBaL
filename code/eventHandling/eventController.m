...
%         figure_settings_file;
    ...
    methods
        function this = eventController(data_custodian, event_data)
            ...
            this.condition_label = uicontrol(files_panel, 'Style', 'text', 'Position', [75, files_panel_height-32, 80, 15], 'Fontsize', 12, 'String', this.data_custodian.trial_type, 'HorizontalAlignment', 'left', 'BackgroundColor', 'white');
            ...
            this.trial_number_label = uicontrol(files_panel, 'Style', 'text', 'Position', [235, files_panel_height-32, 80, 15], 'Fontsize', 12, 'String', num2str(this.data_custodian.trial_number), 'HorizontalAlignment', 'left', 'BackgroundColor', 'white');
