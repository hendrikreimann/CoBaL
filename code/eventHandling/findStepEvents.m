...
%             [cop_trajectories, time_forceplate, ~, ~, ~, ~] = loadData(collection_date, subject_id, condition, i_trial, 'total_forceplate_cop_world', 'optional');
            ...
            if any(strcmp(subject_settings.get('event_method', 1), 'cop_ap'))
                ...
                [~, pushoff_indices_both] = findpeaks ...
                    ( ...
                      cop_y, ...
                      'MinPeakProminence', subject_settings.get('peak_prominence_threshold'), ...
                      'MinPeakDistance', subject_settings.get('min_peak_distance', 1) ...
                    );
                [~, touchdown_indices_both] = findpeaks ...
                    ( ...
                      -cop_y, ...
                      'MinPeakProminence', subject_settings.get('peak_prominence_threshold'), ...
                      'MinPeakDistance', subject_settings.get('min_peak_distance', 1) ...
