        ...
        if exist(source_dir, 'dir')
            ...
            for i_file = 1 : number_of_files
                    ...
                    while import_more_data
                        ...
                        if isstruct(imported_data)
                            ...
                            elseif strcmp(data_class, 'Trajectories')
                                ...
                                % triplicate labels
                                number_of_markers = length(marker_headers);
                ...
                elseif strcmp(file_type, 'qualisysData')
                    ...
                    marker_names = marker_labels_strings(2 : end);
                    ...
                    % triplicate labels
                    number_of_markers = length(marker_names);
                    marker_labels = cell(3, number_of_markers);
                    for i_marker = 1 : length(marker_labels)
                        marker_labels{1, i_marker} = [marker_names{i_marker} '_x'];
                        marker_labels{2, i_marker} = [marker_names{i_marker} '_y'];
                        marker_labels{3, i_marker} = [marker_names{i_marker} '_z'];
                    end
                    marker_labels = reshape(marker_labels, 1, number_of_markers*3);
                  ...
                  % note: changed this to add directions, but not tested yet
...
%                         'sampling_rate_forceplate' ...
%                       );
%                     error('Trying to import NeuroCom forceplate data, but this part of the code has not been updated yet. Please add direction information.')
%                   
