    ...
    for i_variable = 1 : number_of_variables_to_plot
        ...
        for i_comparison = 1 : length(comparison_indices);
            ...
            if ~isempty(study_settings.conditions_control)
                ...
                % extract condition indicator for control
                ...
                if strcmp(study_settings.plot_mode, 'detailed')
                    ...
                    plot ...
                      ( ...
                        data_to_plot(:, this_condition_indicator), ...
                    ...
                    control_mean_plot = plot ...
                      ( ...
                        mean(data_to_plot(:, this_condition_indicator), 2), ...
                        'DisplayName', 'CONTROL', ...
                        'linewidth', 5, ...
            ...
            for i_condition = 1 : length(this_comparison)
                ...
                condition_identifier = study_settings.conditions_to_plot(this_comparison(i_condition), :);
...
%                 set(gca, 'xlim', [time_normalized(1), time_normalized(end)]);
                ylim = [str2double(study_settings.variables_to_plot{i_variable, 5}), str2double(study_settings.variables_to_plot{i_variable, 6})];
