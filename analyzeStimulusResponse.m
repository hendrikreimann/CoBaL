...
%     stretch_length_indices_forceplate = [];
    ...
    for i_condition = 1 : length(condition_list)
        ...
        for i_trial = trials_to_process
            ...
            if process_data_balance
                ...
                com_x_pos_trajectory = fillmissing(com_x_pos_trajectory, 'spline');
                com_y_pos_trajectory = fillmissing(com_y_pos_trajectory, 'spline');
                
                if visualize_com
                    f = figure; hold on;
                    plot(com_x_pos_trajectory)
                    distFig
    ...
    if process_data_balance
        ...
        for i_condition = 1 : number_of_conditions_control
            ...
            rheel_x_pos_com_control_means(:, i_condition) = mean(rheel_x_pos_com_normalized_all(:, condition_indicator), 2);            trunk_angle_ml_control_means(:, i_condition) = mean(trunk_angle_ml_normalized_all(:, condition_indicator), 2);
