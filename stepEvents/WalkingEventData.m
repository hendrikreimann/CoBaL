classdef WalkingEventData < handle
    ...
    methods
        ...
        function loadEvents(this)
            loaded_event_data = load([this.trial_data.data_directory filesep makeFileName(this.trial_data.date, this.trial_data.subject_id, this.trial_data.condition, this.trial_data.trial_number, 'stepEvents')]);
