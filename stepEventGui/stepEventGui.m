...
% the following is where the figures and data plots are hard coded, this is being replaced with loading it from the
% settings file, but we're keeping this around for now for reference
if false
    %% set plot stuff
