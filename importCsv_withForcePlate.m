...
for i_trial = 1 : number_of_files
    ...
    if strcmp(csv_data_file_name(last_underscore+1 : end-4), 'forcePlateData')
        ...
        if strcmp(imported_data.textdata{1, 1}, 'Devices')
            ...
            forceplate_trajectories_raw = data_devices.data(:, 3:8);
            emg_trajectories_raw = data_devices.data(:, 9:16);
            ...
            % save emg data
            matlab_data_file_name = [csv_data_file_name(1 : end-4) '_deviceTrajectoriesRawOne.mat'];
            save ...
              ( ...
                matlab_data_file_name, ...
            ...
            % import devices data - second block
            number_of_data_points_devices_one = size(data_devices.data, 1);
            [imported_data, delimiter, nheaderlines] = importdata(csv_data_file_name, ',', 5 + number_of_data_points_devices_one + 7);
            
            data_devices = imported_data;
            sampling_rate_emg = str2num(data_devices.textdata{5 + number_of_data_points_devices_one + 3, 1});
            forceplate_trajectories_raw = data_devices.data(:, 3:8);
            emg_trajectories_raw = data_devices.data(:, 9:16);
            ...
            % save emg data
            matlab_data_file_name = [csv_data_file_name(1 : end-4) '_deviceTrajectoriesRawTwo.mat'];
            save ...
              ( ...
                matlab_data_file_name, ...
                'emg_trajectories_raw', ...
            ...
            % import marker data
            number_of_data_points_devices_two = size(data_devices.data, 1);
            [data_markers, delimiter, nheaderlines] = importdata(csv_data_file_name, ',', 5 + number_of_data_points_devices_one + 7 + number_of_data_points_devices_two + 6);
            sampling_rate_mocap = str2num(data_markers.textdata{5 + number_of_data_points_devices_one + 7 + number_of_data_points_devices_two + 3, 1});
