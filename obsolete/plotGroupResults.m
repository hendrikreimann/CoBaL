...
function plotGroupResults(varargin)
    %% parse input
    parser = inputParser;
    parser.KeepUnmatched = true;
    addParameter(parser, 'subjects_groups', [])
    ...
    subjects = parser.Results.subjects_groups;
    ...
    data_folder_list = determineDataStructureSpecialGroups(subjects);
