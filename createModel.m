...
if create_plant
    plant = walkingModel ...
      ( ...
        ...
        height, ...
        { ...
          right_hip_cor, right_knee_point, right_ankle_cor, ...
          left_hip_cor, left_knee_point, left_ankle_cor...
        }, ...
        {right_knee_aor, left_knee_aor}, ...
        marker_reference, ...
        gender ...
      );
...
if show_visualization
    ...
    shape_cuboid = ...
      { ...
        'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', ...
        'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', ...
        'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', ...
        'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', 'cuboid', ...
      };
    shape_ellipsoid = ...
      { ...
        'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', ...
        'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', ...
        'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', ...
        'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', 'ellipsoid', ...
      };
    
%     stickFigure = KinematicTreeStickFigure(plant, scene_bound, shape_ellipsoid);
