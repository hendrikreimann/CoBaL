...
% continuous_variable_info = [continuous_variable_info; {'cop_x_com_response', 'total CoP response, ml, rel. to CoM', 'CoP (m)', 'copxRspCom', [-0.02 0.02], 'right', 'left'}];
...
continuous_variable_info = [continuous_variable_info; {'lglutmed_rescaled_response', 'left Gluteus Medius', 'EMG', 'lglutmedRsp', [-2.5 2.5], '+', '-'}];
continuous_variable_info = [continuous_variable_info; {'ltibiant_rescaled_response', 'left Tibialis Anterior', 'EMG', 'ltibiantRsp', [-2.5 2.5], '+', '-'}];
continuous_variable_info = [continuous_variable_info; {'lgastroc_rescaled_response', 'left Gastrocnemius Medialis', 'EMG', 'lgastrocRsp', [-2.5 2.5], '+', '-'}];
continuous_variable_info = [continuous_variable_info; {'lperolng_rescaled_response', 'left Peroneus Longus', 'EMG', 'lperolngRsp', [-2.5 2.5], '+', '-'}];
% continuous_variable_info = [continuous_variable_info; {'rglutmed_rescaled_response', 'right Gluteus Medius', 'EMG', 'rglutmedRsp', [-2.5 2.5], '+', '-'}];
% continuous_variable_info = [continuous_variable_info; {'rtibiant_rescaled_response', 'right Tibialis Anterior', 'EMG', 'rtibiantRsp', [-2.5 2.5], '+', '-'}];
% continuous_variable_info = [continuous_variable_info; {'rgastroc_rescaled_response', 'right Gastrocnemius Medialis', 'EMG', 'rgastrocRsp',[-2.5 2.5], '+', '-'}];
% continuous_variable_info = [continuous_variable_info; {'rperolng_rescaled_response', 'right Peroneus Longus', 'EMG', 'rperolngRsp', [-2.5 2.5], '+', '-'}];
