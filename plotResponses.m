...
if do_heel_plots_single
    ...
    figure; axes; hold on; title(['right foot medial-lateral heel pos, 0ms, N = ' num2str(sum(conditions_stanceR_0ms))]); set(gca, 'Fontsize', 12)
    ...
    plot(time_normalized, lheel_x_pos_normalized_total(:, conditions_stanceR_stimNeg_150ms), 'color', lightenColor(color_negative, 0.5));
    plot(time_normalized, lheel_x_pos_normalized_total(:, conditions_stanceR_stimPos_150ms), 'color', lightenColor(color_positive, 0.5));
    plot(time_normalized, mean(lheel_x_pos_normalized_total(:, conditions_stanceR_stimNeg_150ms), 2), 'color', color_negative, 'linewidth', 5);
    plot(time_normalized, mean(lheel_x_pos_normalized_total(:, conditions_stanceR_stimPos_150ms), 2), 'color', color_positive, 'linewidth', 5);
    ...
    plot(time_normalized, rheel_x_pos_normalized_total(:, conditions_stanceL_stimNeg_450ms), 'color', lightenColor(color_negative, 0.5));
    plot(time_normalized, rheel_x_pos_normalized_total(:, conditions_stanceL_stimPos_450ms), 'color', lightenColor(color_positive, 0.5));
    plot(time_normalized, mean(rheel_x_pos_normalized_total(:, conditions_stanceL_stimNeg_450ms), 2), 'color', color_negative, 'linewidth', 5);
    plot(time_normalized, mean(rheel_x_pos_normalized_total(:, conditions_stanceL_stimPos_450ms), 2), 'color', color_positive, 'linewidth', 5);    
...
if do_heel_plots_absolute_left
    ...
    control_plot = shadedErrorBar(time_normalized, lheel_x_pos_mean_stanceL_control, lheel_x_pos_civ_stanceL_control, {'color', color_control, 'linewidth', 5}, 1);
    positive_plot = shadedErrorBar(time_normalized, lheel_x_pos_mean_stanceL_stimPos_0ms, lheel_x_pos_civ_stanceL_stimPos_0ms, {'color', color_positive, 'linewidth', 5}, 1);
    negative_plot = shadedErrorBar(time_normalized, lheel_x_pos_mean_stanceL_stimNeg_0ms, lheel_x_pos_civ_stanceL_stimNeg_0ms, {'color', color_negative, 'linewidth', 5}, 1);
    xlabel('time'); set(gca, 'xlim', [time_normalized(1) time_normalized(end)]); 
    this_legend = legend([control_plot.mainLine positive_plot.mainLine negative_plot.mainLine], 'control', 'illusion left', 'illusion right');
    set(this_legend, 'Location', 'NORTHWEST')
    xlimits = get(gca, 'xlim'); ylimits = get(gca, 'ylim');
...
if do_heel_plots_response_left
    ...
    positive_plot = shadedErrorBar(time_normalized, lheel_x_pos_response_mean_stanceL_stimPos_0ms, lheel_x_pos_response_civ_stanceL_stimPos_0ms, {'color', color_positive, 'linewidth', 5}, 1);
    negative_plot = shadedErrorBar(time_normalized, lheel_x_pos_response_mean_stanceL_stimNeg_0ms, lheel_x_pos_response_civ_stanceL_stimPos_0ms, {'color', color_negative, 'linewidth', 5}, 1);
    xlabel('time'); set(gca, 'xlim', [time_normalized(1) time_normalized(end)], 'ylim', [-0.015 0.015]);
    this_legend = legend([positive_plot.mainLine negative_plot.mainLine], 'illusion left', 'illusion right');
    set(this_legend, 'Location', 'NORTHWEST')
    xlimits = get(gca, 'xlim'); ylimits = get(gca, 'ylim');
