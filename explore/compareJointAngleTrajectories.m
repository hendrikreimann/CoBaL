...
%         plot(time_mocap, joint_angle_trajectories(:, i_joint), 'color', joint_angle_simulated_plot.Color, 'linestyle', '-', 'linewidth', 1, 'displayname', num2str(i_joint));
        plot(time_mocap, joint_angle_trajectories_calculated(:, i_joint), 'color', joint_angle_simulated_plot.Color, 'linestyle', '-', 'linewidth', 1, 'displayname', num2str(i_joint));
        plot(time_mocap, joint_angle_trajectories_optimized(:, i_joint), 'color', joint_angle_simulated_plot.Color, 'linestyle', '--', 'linewidth', 1, 'displayname', num2str(i_joint));
    end
    legend('show')
end
